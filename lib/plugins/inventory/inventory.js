...
module.exports = (bot, { ItemStackRequest }) => {
    ...
    const Window = require('./types/window')(bot, { ItemStackRequest })
    ...
    //-----------------------------------------------------------------------------------
    // This funciton is to be replaced by bot.bedrock.activateBlock
    // Not sure why I decided to wait for inventory content etc, but worried other
    // functions might break.
    // placeBlock and _genericPlace reproduces this logic (also fix)

...
module.exports = (bot) => {
    ...
    const updateEntityAttributes = bot.updateEntityAttributes
    ...
    bot._client.on('add_player', (packet) => {
        ...
        // packet.abilities = '<DELETED>'        
        // console.log('add_player', packet)

        //packet.held_item //TODO
        //packet.gamemode //TODO
        //packet.properties: { ints: [], floats: [] } //TODO?
        //packet.abilities: [ ...  ], //TODO?
        //packet.permission_level: 'operator', //TODO?
        //packet.command_permission: 'operator', //TODO?
        //packet.links //TODO
        // platform_chat_id: '',
        // device_id: ... ,
        // device_os: 'Win10',

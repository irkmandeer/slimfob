...
module.exports = (bot) => {
    ...
    bot.on('death', () => { shouldUsePhysics = false }) //Dead
    bot.on('spawn', () => { shouldUsePhysics = true }) //Not dead //TODO: Check if riding
    ...
    bot.on('gameTick', () => {
        ...
        if (bot.physicsEnabled && shouldUsePhysics) {
            ...
            if (bot.physicsDebug) console.log('physicsDebug:', bot.entity.position.toString(), 'Jump:', controlState.jump)
